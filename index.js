...
(async () => {
    ...
    await traversePath('original', {
        ...
        onFile: async f => {
            ...
            const c2 = mapRecursive.mapRecursiveKey( c1, v => v.replace(/^(@|rdf:|rdfs:|http:\/\/schema.org\/)/, ""));
            const c3 = mapRecursive.mapRecursiveLeaf(c2, v => v.replace(/^(@|rdf:|rdfs:|http:\/\/schema.org\/)/, ""));
